...
import { Shield, ChevronRight, ChevronLeft, CheckCircle2, AlertCircle, Eye, EyeOff } from "lucide-react";
      ...
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", background: "var(--background)" }}>
        <div className="card" style={{ maxWidth: "420px", width: "100%", padding: "2.5rem", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "0.875rem", color: "var(--foreground-muted)", marginBottom: "1.75rem", lineHeight: 1.65 }}>
            Your student account has been created. You can now sign in with your Matric or Registration Number and password.
          </p>
      ...
      <div style={{ width: "100%", maxWidth: "560px" }}>
        ...
        <div className="card">
          <div className="card-header">
            <h2 style={{ marginBottom: "0.25rem" }}>Create Student Account</h2>
            ...
            {step === 0 && (
              <form onSubmit={handleStep1} noValidate>
                <div className="form-group">
                  ...
                  <input type="text" className="form-input" placeholder="e.g. Solomon Adebayo" {...form1.register("full_name")} />
                ...
                <div className="form-group">
                  ...
                  <input type="email" className="form-input" placeholder="your.email@example.com" {...form1.register("email")} />
